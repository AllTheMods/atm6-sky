onEvent(`recipes`, e => {
  ...
  mekCrush(`excompressum:compressed_crushed_nether_gravel`, `compressium:netherrack_1`)
  mekCrush(`excompressum:compressed_crushed_ender_gravel`, `compressium:endstone_1`)
