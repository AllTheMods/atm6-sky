...
events.listen('item.tags', function (e) {
  ...
  */
  ...
  add('forge:ores', ['#forge:ores/certus_quartz', '#forge:ores/oratchalcum', '#forge:ores/rat_gem', '#forge:ores/dimensionalshard', '#forge:ores/arcane_brick', 'kubejs:chunk_mod', 'kubejs:chunk_vib', 'kubejs:chunk_unob'])
  ...
  add('forge:ores/allthemodium', ['kubejs:chunk_mod'])
  add('forge:ores/vibranium', ['kubejs:chunk_vib'])
  add('forge:ores/unobtainium', ['kubejs:chunk_unob'])
