...
onEvent(`block.tags`, e => {
  ...
  e.add(`resourcefulbees:valid_apiary`, [`#repurposed_structures:nether_stronghold_bookshelves`, `#misctags:concrete`, `#mcwwindows:window`, `modularrouters:item_router`, `minecraft:soul_sand`, `#minecraft:nylium`, `minecraft:soul_soil`, `minecraft:glowstone`, `minecraft:water`]);
  ...
  //Flowers
  e.add(`resourcefulbees:valid_apiary`, [`minecraft:lava`, `botania:blaze_block`, `minecraft:magma_block`, `minecraft:clay`, `minecraft:water`, `appliedenergistics2:quartz_block`, `astralsorcery:starmetal`]);
