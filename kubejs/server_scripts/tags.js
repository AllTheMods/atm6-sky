...
onEvent('item.tags', e => {
  ...
  */
  ...
  e.add('forge:ores', ['#forge:ores/certus_quartz', '#forge:ores/allthemodium', '#forge:ores/vibranium', '#forge:ores/unobtainium']);
  ...
  */
  ...
  e.revemo('forge:dyes/yellow', ('#forge:dusts/sulfur'));
  e.revemo('forge:dyes', ('#forge:dusts/sulfur'));
